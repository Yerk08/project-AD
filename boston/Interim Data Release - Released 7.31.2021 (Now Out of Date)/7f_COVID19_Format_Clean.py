...
from COVID19_QC import daily_QC, demo_QC, R1_QC, R2_QC, R3_QC, R4_QC, R5_QC, R6_QC
...
#Import raw data
df_short = pd.read_csv(join(main_dir, 'raw_data', 'COVIDLongitudinalDat_DATA_2021-07-20_1317.csv'))
df_long  = pd.read_csv(join(main_dir, 'raw_data', 'COVID19LongitudinalD_DATA_2021-07-20_1315.csv'))
demo     = pd.read_csv(join(main_dir, 'raw_data', 'COVID19-DEMOREPORT_DATA_2021-07-20_1318.csv'))
r1 = pd.read_csv(join(main_dir, 'raw_data', 'Round1', 'Round1COVIDAdditiona_DATA_2021-07-20_1322.csv'))
r2 = pd.read_csv(join(main_dir, 'raw_data', 'Round2', 'Round2COVIDAdditiona_DATA_2021-07-20_1322.csv'))
r3 = pd.read_csv(join(main_dir, 'raw_data', 'Round3', 'Round3COVIDAdditiona_DATA_2021-07-20_1322.csv'))
r4 = pd.read_csv(join(main_dir, 'raw_data', 'Round4', 'Round4COVIDAdditiona_DATA_2021-07-20_1323.csv'))
r5 = pd.read_csv(join(main_dir, 'raw_data', 'Round5', 'Round5COVIDAdditiona_DATA_2021-07-20_1323.csv'))
april18_data = pd.read_csv(join(main_dir, 'raw_data', 'Round6', 'April18_DATA_2021-07-20_1323.csv'))

#Extract Round 6 data from the April 18 data
r6_vars = list(april18_data.loc[:, 'telephoneapril_fear': 'perished_2'].columns)
r6 = april18_data[['record_id', 'april_18_timestamp', 'subjid_2', 'todays_date', *r6_vars]].copy()
...
data = pd.concat((data, april18_daily))

del df_short, df_long, april18_data, april18_daily
...
#Remove non-printing space form sub IDs
...
assert all(data['redcap_repeat_instrument'].isna() == data['april_18_complete'].notna())
